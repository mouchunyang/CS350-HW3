...
main(int argc, char *argv[]){
  ...
  16:	75 35                	jne    4d <main+0x4d>
  18:	bb 80 96 98 00       	mov    $0x989680,%ebx
  ...
  35:	75 e9                	jne    20 <main+0x20>
	    ...
	    getpinfo(getpid());
  37:	e8 16 03 00 00       	call   352 <getpid>
  3c:	83 ec 0c             	sub    $0xc,%esp
  3f:	50                   	push   %eax
  40:	e8 2d 03 00 00       	call   372 <getpinfo>
  45:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  48:	e8 85 02 00 00       	call   2d2 <exit>
        printf(1, "val: %d\n", val);
  4d:	50                   	push   %eax
  4e:	68 00 ca 9a 3b       	push   $0x3b9aca00
  53:	68 7a 07 00 00       	push   $0x77a
  58:	6a 01                	push   $0x1
  5a:	e8 c1 03 00 00       	call   420 <printf>
        getpinfo(getpid());
  5f:	e8 ee 02 00 00       	call   352 <getpid>
  64:	89 04 24             	mov    %eax,(%esp)
  67:	e8 06 03 00 00       	call   372 <getpinfo>
  6c:	83 c4 10             	add    $0x10,%esp
  6f:	eb d7                	jmp    48 <main+0x48>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 83 07 00 00       	mov    $0x783,%ebx
        while(*s != 0){
