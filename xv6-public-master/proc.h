...
struct proc {
  ...
  //change: add member variables representing which level and the current number of ticks
  //also add a member variable that shows how long it has stayed in q2
  uint level;
  uint num_ticks;
  uint q2_ticks;
