...
main(int argc, char *argv[]){
  15:	83 ec 0c             	sub    $0xc,%esp
	int pid=getpid();
  18:	e8 65 03 00 00       	call   382 <getpid>
  1d:	89 c6                	mov    %eax,%esi
	fork();
  1f:	e8 d6 02 00 00       	call   2fa <fork>
  ...
  2b:	6a 01                	push   $0x1
  2d:	e8 60 03 00 00       	call   392 <sleep>
	for(int i=0;i<400;i++){
 ...
 //    wait();
	// wait();
	wait();
  3a:	e8 cb 02 00 00       	call   30a <wait>
	if(pid != getpid()){
  3f:	e8 3e 03 00 00       	call   382 <getpid>
  44:	39 f0                	cmp    %esi,%eax
  46:	74 11                	je     59 <main+0x59>
		//wait();
		getpinfo(getpid());
  48:	e8 35 03 00 00       	call   382 <getpid>
  4d:	83 ec 0c             	sub    $0xc,%esp
  50:	50                   	push   %eax
  51:	e8 4c 03 00 00       	call   3a2 <getpinfo>
  56:	83 c4 10             	add    $0x10,%esp
	}
	exit();
  59:	e8 a4 02 00 00       	call   302 <exit>
  5e:	66 90                	xchg   %ax,%ax
...
int fib(int i){
  68:	83 ec 1c             	sub    $0x1c,%esp
  6b:	8b 45 08             	mov    0x8(%ebp),%eax
	if(i<2){
  6e:	83 f8 01             	cmp    $0x1,%eax
  71:	7e 2e                	jle    a1 <fib+0x41>
  73:	8d 50 fe             	lea    -0x2(%eax),%edx
  76:	8d 78 fd             	lea    -0x3(%eax),%edi
  79:	8d 58 ff             	lea    -0x1(%eax),%ebx
  7c:	89 d0                	mov    %edx,%eax
  7e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  81:	83 e0 fe             	and    $0xfffffffe,%eax
  84:	29 c7                	sub    %eax,%edi
		return fib(i-1)+fib(i-2);
  86:	83 ec 0c             	sub    $0xc,%esp
  89:	53                   	push   %ebx
  8a:	83 eb 02             	sub    $0x2,%ebx
  8d:	e8 ce ff ff ff       	call   60 <fib>
  92:	83 c4 10             	add    $0x10,%esp
  95:	01 c6                	add    %eax,%esi
	if(i<2){
  97:	39 fb                	cmp    %edi,%ebx
  99:	75 eb                	jne    86 <fib+0x26>
  9b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  9e:	83 e0 01             	and    $0x1,%eax
}
  a1:	8d 65 f4             	lea    -0xc(%ebp),%esp
 ...
 621:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 88 0a 00 00       	mov    %eax,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 ...
 777:	0a 00 00 
 77a:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 789:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 790:	00 00 00 
