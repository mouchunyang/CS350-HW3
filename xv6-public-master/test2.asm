...
main(int argc, char *argv[]){
  ...
  11:	83 ec 28             	sub    $0x28,%esp
	...
	if(fork()!=0){
  14:	e8 61 03 00 00       	call   37a <fork>
  19:	85 c0                	test   %eax,%eax
  1b:	74 5a                	je     77 <main+0x77>
  1d:	b9 25 00 00 00       	mov    $0x25,%ecx
  22:	31 db                	xor    %ebx,%ebx
  24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		return fib(i-1)+fib(i-2);
  28:	83 ec 0c             	sub    $0xc,%esp
  2b:	51                   	push   %ecx
  2c:	e8 af 00 00 00       	call   e0 <fib>
  31:	83 e9 02             	sub    $0x2,%ecx
  34:	83 c4 10             	add    $0x10,%esp
  37:	01 c3                	add    %eax,%ebx
	if(i<2){
  39:	83 f9 ff             	cmp    $0xffffffff,%ecx
  3c:	75 ea                	jne    28 <main+0x28>
		//pid==3
		printf(1,"result is %d\n",fib(38));
  3e:	83 ec 04             	sub    $0x4,%esp
  41:	53                   	push   %ebx
  42:	68 28 08 00 00       	push   $0x828
  47:	6a 01                	push   $0x1
  49:	e8 82 04 00 00       	call   4d0 <printf>
		//end=1;
		printf(1,"ended\n");
  4e:	58                   	pop    %eax
  4f:	5a                   	pop    %edx
  50:	68 36 08 00 00       	push   $0x836
  55:	6a 01                	push   $0x1
  ...
  5c:	83 c4 10             	add    $0x10,%esp
	...
	wait();
  5f:	e8 26 03 00 00       	call   38a <wait>
	//if(pid==getpid()){
		//wait();
	getpinfo(getpid());
  64:	e8 99 03 00 00       	call   402 <getpid>
  69:	83 ec 0c             	sub    $0xc,%esp
  6c:	50                   	push   %eax
  6d:	e8 b0 03 00 00       	call   422 <getpinfo>
	//}
	exit();
  72:	e8 0b 03 00 00       	call   382 <exit>
  77:	8d 75 d4             	lea    -0x2c(%ebp),%esi
		fork();
  7a:	bf 90 01 00 00       	mov    $0x190,%edi
		fork();
  7f:	e8 f6 02 00 00       	call   37a <fork>
		fork();
  84:	e8 f1 02 00 00       	call   37a <fork>
		fork();
  89:	e8 ec 02 00 00       	call   37a <fork>
  8e:	66 90                	xchg   %ax,%ax
  90:	bb 03 00 00 00       	mov    $0x3,%ebx
				int fd=open("test1_2.c", O_RDONLY);
  95:	83 ec 08             	sub    $0x8,%esp
  98:	6a 00                	push   $0x0
  9a:	68 3d 08 00 00       	push   $0x83d
  9f:	e8 1e 03 00 00       	call   3c2 <open>
				read(fd,buf,sizeof buf);
  a4:	83 c4 0c             	add    $0xc,%esp
  a7:	6a 14                	push   $0x14
  a9:	56                   	push   %esi
  aa:	50                   	push   %eax
  ab:	e8 ea 02 00 00       	call   39a <read>
			for (int j = 0; j < 3; ++j){
  b0:	83 c4 10             	add    $0x10,%esp
  b3:	83 eb 01             	sub    $0x1,%ebx
  b6:	75 dd                	jne    95 <main+0x95>
			sleep(1);
  b8:	83 ec 0c             	sub    $0xc,%esp
  bb:	6a 01                	push   $0x1
  bd:	e8 50 03 00 00       	call   412 <sleep>
		for(int i=0;i<400;i++){
  c2:	83 c4 10             	add    $0x10,%esp
  c5:	83 ef 01             	sub    $0x1,%edi
  c8:	75 c6                	jne    90 <main+0x90>
		wait();
  ca:	e8 bb 02 00 00       	call   38a <wait>
		wait();
  cf:	e8 b6 02 00 00       	call   38a <wait>
  d4:	eb 89                	jmp    5f <main+0x5f>
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
...
int fib(int i){
  e8:	83 ec 1c             	sub    $0x1c,%esp
  eb:	8b 45 08             	mov    0x8(%ebp),%eax
	if(i<2){
  ee:	83 f8 01             	cmp    $0x1,%eax
  f1:	7e 2e                	jle    121 <fib+0x41>
  f3:	8d 50 fe             	lea    -0x2(%eax),%edx
  f6:	8d 78 fd             	lea    -0x3(%eax),%edi
  f9:	8d 58 ff             	lea    -0x1(%eax),%ebx
  fc:	89 d0                	mov    %edx,%eax
  fe:	89 55 e4             	mov    %edx,-0x1c(%ebp)
 101:	83 e0 fe             	and    $0xfffffffe,%eax
 104:	29 c7                	sub    %eax,%edi
		return fib(i-1)+fib(i-2);
 ...
 11e:	83 e0 01             	and    $0x1,%eax
}
 121:	8d 65 f4             	lea    -0xc(%ebp),%esp
 124:	01 f0                	add    %esi,%eax
 126:	5b                   	pop    %ebx
 127:	5e                   	pop    %esi
 128:	5f                   	pop    %edi
 129:	5d                   	pop    %ebp
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 47 08 00 00       	mov    $0x847,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 2c 0b 00 00    	cmp    %eax,0xb2c
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 30 0b 00 00       	mov    $0xb30,%eax
 809:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 810:	00 00 00 
