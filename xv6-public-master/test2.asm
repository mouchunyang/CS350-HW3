...
main(int argc, char *argv[]){
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
	int pid=getpid();
  13:	e8 ca 03 00 00       	call   3e2 <getpid>
	volatile int end=0;
  18:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	int pid=getpid();
  1f:	89 c6                	mov    %eax,%esi

	if(fork()!=0){
  21:	e8 34 03 00 00       	call   35a <fork>
  26:	85 c0                	test   %eax,%eax
  28:	74 5b                	je     85 <main+0x85>
  2a:	b9 22 00 00 00       	mov    $0x22,%ecx
  2f:	31 db                	xor    %ebx,%ebx
  31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		return fib(i-1)+fib(i-2);
  38:	83 ec 0c             	sub    $0xc,%esp
  3b:	51                   	push   %ecx
  3c:	e8 7f 00 00 00       	call   c0 <fib>
  41:	83 c4 10             	add    $0x10,%esp
  44:	01 c3                	add    %eax,%ebx
	if(i<2){
  46:	83 e9 02             	sub    $0x2,%ecx
  ...
  5c:	59                   	pop    %ecx
  5d:	5b                   	pop    %ebx
  5e:	68 16 08 00 00       	push   $0x816
  63:	6a 01                	push   $0x1
		end=1;
  65:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
		printf(1,"ended\n");
  6c:	e8 3f 04 00 00       	call   4b0 <printf>
  71:	83 c4 10             	add    $0x10,%esp
  74:	eb 27                	jmp    9d <main+0x9d>
  ...
  8a:	74 f4                	je     80 <main+0x80>
		}
		printf(1,"exited\n");
  8c:	50                   	push   %eax
  8d:	50                   	push   %eax
  8e:	68 1d 08 00 00       	push   $0x81d
  93:	6a 01                	push   $0x1
  ...
  9a:	83 c4 10             	add    $0x10,%esp
	...
	//wait();
	if(getpid()==pid){
  9d:	e8 40 03 00 00       	call   3e2 <getpid>
  a2:	39 f0                	cmp    %esi,%eax
  a4:	74 05                	je     ab <main+0xab>
		getpinfo(getpid());
	}
	exit();
  a6:	e8 b7 02 00 00       	call   362 <exit>
		getpinfo(getpid());
  ab:	e8 32 03 00 00       	call   3e2 <getpid>
  b0:	83 ec 0c             	sub    $0xc,%esp
  b3:	50                   	push   %eax
  b4:	e8 49 03 00 00       	call   402 <getpinfo>
  b9:	83 c4 10             	add    $0x10,%esp
  bc:	eb e8                	jmp    a6 <main+0xa6>
  be:	66 90                	xchg   %ax,%ax
...
int fib(int i){
  ...
  d1:	7e 2e                	jle    101 <fib+0x41>
  d3:	8d 50 fe             	lea    -0x2(%eax),%edx
  d6:	8d 78 fd             	lea    -0x3(%eax),%edi
  d9:	8d 58 ff             	lea    -0x1(%eax),%ebx
  dc:	89 d0                	mov    %edx,%eax
  de:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  e1:	83 e0 fe             	and    $0xfffffffe,%eax
  e4:	29 c7                	sub    %eax,%edi
		return fib(i-1)+fib(i-2);
  e6:	83 ec 0c             	sub    $0xc,%esp
  e9:	53                   	push   %ebx
  ea:	83 eb 02             	sub    $0x2,%ebx
  ed:	e8 ce ff ff ff       	call   c0 <fib>
  f2:	83 c4 10             	add    $0x10,%esp
  f5:	01 c6                	add    %eax,%esi
	if(i<2){
  f7:	39 fb                	cmp    %edi,%ebx
  f9:	75 eb                	jne    e6 <fib+0x26>
  fb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  fe:	83 e0 01             	and    $0x1,%eax
}
 101:	8d 65 f4             	lea    -0xc(%ebp),%esp
 104:	01 f0                	add    %esi,%eax
 106:	5b                   	pop    %ebx
 107:	5e                   	pop    %esi
 108:	5f                   	pop    %edi
 109:	5d                   	pop    %ebp
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 25 08 00 00       	mov    $0x825,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 04 0b 00 00    	mov    0xb04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 04 0b 00 00    	cmp    %eax,0xb04
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 7d7:	0b 00 00 
 7da:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 7e1:	0b 00 00 
    base.s.size = 0;
 7e4:	b8 08 0b 00 00       	mov    $0xb08,%eax
 7e9:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 7f0:	00 00 00 
