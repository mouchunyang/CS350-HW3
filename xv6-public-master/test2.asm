...
main(int argc, char *argv[]){
  ...
  11:	83 ec 28             	sub    $0x28,%esp
	int pid=getpid();
  14:	e8 f9 03 00 00       	call   412 <getpid>
  19:	89 c7                	mov    %eax,%edi
	//volatile int end=0;
	
	if(fork()!=0){
  1b:	e8 6a 03 00 00       	call   38a <fork>
  20:	85 c0                	test   %eax,%eax
  22:	74 56                	je     7a <main+0x7a>
  24:	b9 22 00 00 00       	mov    $0x22,%ecx
  ...
  33:	51                   	push   %ecx
  34:	e8 b7 00 00 00       	call   f0 <fib>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	01 c3                	add    %eax,%ebx
	if(i<2){
  3e:	83 e9 02             	sub    $0x2,%ecx
  ...
  49:	53                   	push   %ebx
  4a:	68 38 08 00 00       	push   $0x838
  4f:	6a 01                	push   $0x1
  51:	e8 8a 04 00 00       	call   4e0 <printf>
		//end=1;
		printf(1,"ended\n");
  56:	58                   	pop    %eax
  57:	5a                   	pop    %edx
  ...
  73:	74 63                	je     d8 <main+0xd8>
	...
	exit();
  75:	e8 18 03 00 00       	call   392 <exit>
  7a:	8d 75 d4             	lea    -0x2c(%ebp),%esi
		fork();
  7d:	bb 90 01 00 00       	mov    $0x190,%ebx
		fork();
  82:	e8 03 03 00 00       	call   38a <fork>
		fork();
  87:	e8 fe 02 00 00       	call   38a <fork>
		fork();
  8c:	e8 f9 02 00 00       	call   38a <fork>
  91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			int fd=open("test1_2.c", O_RDONLY);
  98:	83 ec 08             	sub    $0x8,%esp
  9b:	6a 00                	push   $0x0
  9d:	68 4d 08 00 00       	push   $0x84d
  a2:	e8 2b 03 00 00       	call   3d2 <open>
			read(fd,buf,sizeof buf);
  a7:	83 c4 0c             	add    $0xc,%esp
  aa:	6a 14                	push   $0x14
  ac:	56                   	push   %esi
  ad:	50                   	push   %eax
  ae:	e8 f7 02 00 00       	call   3aa <read>
			sleep(1);
  b3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ba:	e8 63 03 00 00       	call   422 <sleep>
		for(int i=0;i<400;i++){
...
int fib(int i){
 ...
 101:	7e 2e                	jle    131 <fib+0x41>
 103:	8d 50 fe             	lea    -0x2(%eax),%edx
 106:	8d 78 fd             	lea    -0x3(%eax),%edi
 109:	8d 58 ff             	lea    -0x1(%eax),%ebx
 10c:	89 d0                	mov    %edx,%eax
 10e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
 111:	83 e0 fe             	and    $0xfffffffe,%eax
 114:	29 c7                	sub    %eax,%edi
		return fib(i-1)+fib(i-2);
 116:	83 ec 0c             	sub    $0xc,%esp
 119:	53                   	push   %ebx
 11a:	83 eb 02             	sub    $0x2,%ebx
 11d:	e8 ce ff ff ff       	call   f0 <fib>
 122:	83 c4 10             	add    $0x10,%esp
 125:	01 c6                	add    %eax,%esi
	if(i<2){
 127:	39 fb                	cmp    %edi,%ebx
 129:	75 eb                	jne    116 <fib+0x26>
 12b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 12e:	83 e0 01             	and    $0x1,%eax
}
 131:	8d 65 f4             	lea    -0xc(%ebp),%esp
 134:	01 f0                	add    %esi,%eax
 136:	5b                   	pop    %ebx
 137:	5e                   	pop    %esi
 138:	5f                   	pop    %edi
 139:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 57 08 00 00       	mov    $0x857,%ebx
        while(*s != 0){
 ...
 6b1:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 3c 0b 00 00    	cmp    %eax,0xb3c
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 807:	0b 00 00 
 80a:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 40 0b 00 00       	mov    $0xb40,%eax
 819:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 820:	00 00 00 
